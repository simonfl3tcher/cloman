...
# Database: my.company
# Generation Time: 2012-11-17 19:27:33 +0000
# ************************************************************
...
INSERT INTO `address` (`Address_ID`, `Address_Line_1`, `Address_Line_2`, `Address_Line_3`, `City`, `Region_Name`, `Postcode`)
VALUES
...
# Dump of table business_to_people
# ------------------------------------------------------------

DROP TABLE IF EXISTS `business_to_people`;

CREATE TABLE `business_to_people` (
...
LOCK TABLES `business_to_people` WRITE;
/*!40000 ALTER TABLE `business_to_people` DISABLE KEYS */;

INSERT INTO `business_to_people` (`b2p_id`, `business_id`, `people_id`)
VALUES
	(15,1,55),
	(19,1,43),
	(23,10,57),
...
INSERT INTO `businesses` (`business_id`, `address_id`, `name`, `phone`, `email`, `disabled`)
VALUES
...
# Dump of table connection_options
# ------------------------------------------------------------
...
LOCK TABLES `connection_options` WRITE;
/*!40000 ALTER TABLE `connection_options` DISABLE KEYS */;

INSERT INTO `connection_options` (`connection_options_id`, `name`)
VALUES
	(1,'ftp'),
	(2,'wodpress'),
	(3,'cs-cart'),
...
INSERT INTO `connections` (`connection_id`, `business_id`, `connection_options_id`, `username`, `username_two`, `password`, `url`, `notes`, `disabled`)
VALUES
...
INSERT INTO `meetings` (`meeting_id`, `name`, `notes`, `business`, `start`, `end`, `who`, `updated_by`, `color`, `all_day`)
VALUES
	(1,'Darren Meeting With ART MODIALE','ben boon',12,'2012-11-06 00:00:00','2012-11-06 00:00:00',1,NULL,'#FF9244',0),
	(3,'IPIC Meeting','Sign Off Meeting',1,'2012-11-08 00:00:00','2012-11-08 00:00:00',1,NULL,'#FF9244',0),
	(4,'IPIC Meeting','Sign Off Meeting',1,'2012-11-14 00:00:00','2012-11-14 00:00:00',1,NULL,'#FF9244',0),
	(5,'Example 21','notes notes notes',1,'2012-11-19 00:00:00','2012-11-19 00:00:00',1,NULL,NULL,0),
	(6,'helloeoeoeoee','',0,'2012-11-22 00:00:00','2012-11-22 00:00:00',1,NULL,NULL,0),
	(8,'huzzarrrrrrrrr','',0,'2012-11-20 00:00:00','2012-11-20 00:00:00',1,NULL,NULL,0),
	(9,'bla bla bla','',0,'2012-11-15 00:00:00','2012-11-15 00:00:00',1,NULL,NULL,0),
	(10,'bla bla bla','',0,'2012-11-15 00:00:00','2012-11-15 00:00:00',1,NULL,NULL,0),
	(11,'bla bla bla','',0,'2012-11-07 00:00:00','2012-11-07 00:00:00',1,NULL,NULL,0),
	(12,'jenwkernewr','',0,'2012-11-09 00:00:00','2012-11-09 00:00:00',1,NULL,NULL,0),
	(13,'example 1','',0,'0000-00-00 00:00:00','0000-00-00 00:00:00',1,NULL,NULL,0),
	(14,'example45','',0,'0000-00-00 00:00:00','0000-00-00 00:00:00',1,NULL,NULL,0),
	(16,'example21','',0,'2012-11-21 09:00:00','2012-11-21 09:00:00',1,NULL,NULL,0),
	...
	(19,'dsfdsfdsfdsfd','',0,'2012-11-20 12:00:00','2012-11-20 17:30:00',1,NULL,NULL,0),
	...
	(28,'hello','notes',0,'2012-11-01 09:00:00','2012-11-01 09:00:00',1,NULL,NULL,0),
	(29,'hello','notes',0,'2012-11-02 09:00:00','0000-00-00 00:00:00',1,1,NULL,0),
...
# Dump of table meetings_to_people
# ------------------------------------------------------------

DROP TABLE IF EXISTS `meetings_to_people`;

CREATE TABLE `meetings_to_people` (
...
LOCK TABLES `meetings_to_people` WRITE;
/*!40000 ALTER TABLE `meetings_to_people` DISABLE KEYS */;

INSERT INTO `meetings_to_people` (`meeting_to_people_id`, `meeting_id`, `people_id`)
VALUES
	(1,1,58),
	(2,2,51),
	(3,3,58),
...
# Dump of table meetings_to_users
# ------------------------------------------------------------

DROP TABLE IF EXISTS `meetings_to_users`;

CREATE TABLE `meetings_to_users` (
...
LOCK TABLES `meetings_to_users` WRITE;
/*!40000 ALTER TABLE `meetings_to_users` DISABLE KEYS */;

INSERT INTO `meetings_to_users` (`meetings_to_users_id`, `meeting_id`, `user_id`)
VALUES
	(1,1,1),
	(2,1,2),
	(3,1,5),
...
INSERT INTO `people` (`people_id`, `name`, `role`, `email`, `phone`, `is_primary_contact`, `notes`, `disabled`, `password`, `has_login_access`, `is_logged_in`)
VALUES
...
# Dump of table project_to_users
# ------------------------------------------------------------
...
INSERT INTO `project_to_users` (`users_to_project_id`, `user_id`, `project_id`)
VALUES
	(1,1,4),
	(2,2,4),
	(3,6,4),
...
INSERT INTO `projects` (`project_id`, `business_id`, `sales_id`, `project_name`, `manager_id`, `project_type_id`, `status_id`, `start_date`, `internal_deadline`, `client_deadline`, `budget`, `notes`, `task_template_id`, `complete`, `completion_date`, `on_hold`, `hold_id`)
VALUES
...
INSERT INTO `projects_comments` (`project_comment_id`, `project_id`, `comment`, `user_id`, `comment_date_time`)
VALUES
...
# Dump of table projects_on_hold
# ------------------------------------------------------------

DROP TABLE IF EXISTS `projects_on_hold`;

CREATE TABLE `projects_on_hold` (
...
LOCK TABLES `projects_on_hold` WRITE;
/*!40000 ALTER TABLE `projects_on_hold` DISABLE KEYS */;

INSERT INTO `projects_on_hold` (`project_hold_id`, `project_id`, `hold_date`, `unhold_date`, `reason`, `done_by`)
VALUES
...
INSERT INTO `reminders` (`reminder_id`, `reminder_time`, `name`, `text`, `remindee`)
VALUES
...
INSERT INTO `settings` (`settings_id`, `name`, `message`)
VALUES
...
INSERT INTO `status_table` (`status_id`, `name`)
VALUES
	(1,'urgent'),
	(2,'semi-urgent'),
	(3,'normal'),
...
LOCK TABLES `support_packs` WRITE;
/*!40000 ALTER TABLE `support_packs` DISABLE KEYS */;

INSERT INTO `support_packs` (`support_packs_id`, `name`, `price`, `description`, `includes`, `time_allowed_pm`, `is_live`)
VALUES
...
# Dump of table support_packs_to_businesses
# ------------------------------------------------------------

DROP TABLE IF EXISTS `support_packs_to_businesses`;

CREATE TABLE `support_packs_to_businesses` (
...
LOCK TABLES `support_packs_to_businesses` WRITE;
/*!40000 ALTER TABLE `support_packs_to_businesses` DISABLE KEYS */;

INSERT INTO `support_packs_to_businesses` (`sptb_id`, `business_id`, `support_pack_id`, `reminder`, `reminder_when`, `renewal_date`, `is_live`)
VALUES
...
INSERT INTO `task_comments` (`task_comment_id`, `task_id`, `comment`, `comment_date_time`, `user_id`)
VALUES
...
LOCK TABLES `task_timesheets` WRITE;
/*!40000 ALTER TABLE `task_timesheets` DISABLE KEYS */;

INSERT INTO `task_timesheets` (`task_timesheet_id`, `user_id`, `task_id`, `time_start`, `task_total_time`, `status`, `completion_date`)
VALUES
...
INSERT INTO `task_types` (`task_type_id`, `name`)
VALUES
	(NULL,'logo'),
	(NULL,'development'),
	(NULL,'hosting');
...
INSERT INTO `tasks` (`task_id`, `lft`, `parent_task_id`, `rgt`, `business_id`, `project_id`, `task_type_id`, `status_id`, `start_date`, `internal_deadline`, `client_deadline`, `name`, `notes`, `status_notes`, `task_created_by`, `last_updated`, `updated_by`, `sort`, `complete`, `actual_completion_date`)
VALUES
	(5,1,0,128,0,11,'2','2','2012-10-05 00:00:00','2012-10-05 00:00:00','2012-10-05 00:00:00','Very Top Level Task','',NULL,1,'2012-10-12 00:00:00',2,14,'N',NULL),
	...
	(39,48,5,113,0,11,'2','2','2012-10-05 00:00:00','2012-10-05 00:00:00','2012-10-05 00:00:00','hosting 2','hosting 2',NULL,1,'2012-10-12 00:00:00',2,12,'Y','2012-10-27 00:00:00'),
	(40,122,5,127,0,11,'2','2','2012-10-05 00:00:00','2012-10-05 00:00:00','2012-10-05 00:00:00','hosting 3','hosting 3',NULL,1,'2012-10-12 00:00:00',2,16,'N',NULL),
	...
	(43,111,39,112,0,11,'2','2','2012-10-05 00:00:00','2012-10-05 00:00:00','2012-10-05 00:00:00','t2','t2',NULL,1,'2012-10-12 00:00:00',2,13,'N','2012-10-22 00:00:00'),
	(44,125,40,126,0,11,'2','2','2012-10-05 00:00:00','2012-10-05 00:00:00','2012-10-05 00:00:00','t3','t3',NULL,1,'2012-10-12 00:00:00',2,15,'Y','2012-10-22 00:00:00'),
	(49,123,5,124,0,11,NULL,NULL,NULL,NULL,NULL,'Get at the top level please',NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL),
	(51,44,5,45,0,11,NULL,NULL,NULL,NULL,NULL,'Hosting working',NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL),
	(52,87,0,88,0,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','Subing a task right here','',NULL,1,NULL,NULL,NULL,'Y','2012-10-16 00:00:00'),
	(53,81,2,82,0,11,'0','0','2012-10-31 00:00:00','2012-10-31 00:00:00','2012-10-31 00:00:00','hello','',NULL,1,NULL,NULL,0,'Y','2012-10-22 00:00:00'),
	(56,40,0,43,0,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','This is a top level task check it out','',NULL,1,NULL,NULL,1,'Y','2012-10-26 00:00:00'),
	(57,77,39,80,1,11,'2','3','2012-10-24 00:00:00','2012-10-22 00:00:00','2012-10-23 00:00:00','This sub tasking','this is a new sub task check it outt...','these are the notes to be made by me and no1 else',1,NULL,NULL,7,'N','2012-10-23 00:00:00'),
	(58,73,39,74,0,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','adding a sub task in here','',NULL,1,NULL,NULL,8,'N',NULL),
	(59,59,39,70,0,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','another sub tree adding','',NULL,1,NULL,NULL,3,'Y','2012-10-27 00:00:00'),
	(60,120,0,121,0,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','tasking 243','',NULL,1,NULL,NULL,9,'N',NULL),
	(61,57,39,58,6,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','sub tasking 24','',NULL,1,'2012-10-22 00:00:00',1,NULL,'Y','2012-10-16 00:00:00'),
	(62,118,0,119,6,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','sub tasking 24999','',NULL,1,'2012-10-22 00:00:00',1,10,'N',NULL),
	(64,53,39,54,2,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','This is a testing sub task check it out...','',NULL,1,'2012-10-22 00:00:00',1,NULL,'Y','2012-10-16 00:00:00'),
	(65,49,39,52,0,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','checking','',NULL,1,NULL,NULL,11,'N',NULL),
	(66,50,65,51,0,11,'0','0','2012-10-25 00:00:00','2012-10-24 00:00:00','2012-10-22 00:00:00','checking sub class man','',NULL,1,NULL,NULL,7,'Y','2012-10-27 00:00:00'),
	(67,114,0,117,0,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','a top level task','',NULL,1,NULL,NULL,8,'Y','2012-10-27 00:00:00'),
	(68,115,67,116,0,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','another sub task within this task ?','',NULL,1,NULL,NULL,12,'N',NULL),
	(69,41,56,42,0,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','subtask of the top level task','',NULL,1,NULL,NULL,10,'Y','2012-10-23 00:00:00'),
	(70,78,57,79,0,11,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','this is a sub task of the containing task if you would like to see it!!','',NULL,1,NULL,NULL,NULL,'Y','2012-10-22 00:00:00'),
	...
	(72,66,59,69,0,0,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','another another subtree','',NULL,1,NULL,NULL,NULL,'Y','2012-10-27 00:00:00'),
	(73,67,72,68,0,0,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','another another another subtree','',NULL,1,NULL,NULL,NULL,'Y','2012-10-27 00:00:00'),
	(74,64,59,65,0,0,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','sdfsdfs','',NULL,1,NULL,NULL,NULL,'Y','2012-10-27 00:00:00'),
	(75,62,59,63,0,0,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','ftgtg','',NULL,1,NULL,NULL,NULL,'Y','2012-10-27 00:00:00'),
	(76,60,59,61,0,0,'0','0','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','gfdghgf','',NULL,1,NULL,NULL,NULL,'Y','2012-10-27 00:00:00'),
	(77,38,0,39,1,5,'0','1','2012-11-20 00:00:00','2012-11-27 00:00:00','2012-11-27 00:00:00','This is a great task','dfsgdfsgfgsdg',NULL,1,NULL,NULL,3,'N',NULL),
	...
	(81,36,0,37,25,0,'0','3','1970-01-01 00:00:00','1970-01-01 00:00:00','1970-01-01 00:00:00','','',NULL,1,NULL,NULL,NULL,'Y','2012-11-08 00:00:00'),
	(82,34,0,35,25,0,'0','3','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','','',NULL,1,NULL,NULL,NULL,'Y','2012-11-08 00:00:00'),
	(83,32,0,33,15,0,'0','3','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','','',NULL,1,NULL,NULL,NULL,'Y','2012-11-08 00:00:00'),
	(84,30,0,31,24,0,'0','3','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','czxvcxvzxc','zcxvzcxvcx',NULL,1,NULL,NULL,0,'N',NULL),
	(85,28,0,29,29,0,'0','2','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','asdasd','asdfdfdf',NULL,1,NULL,NULL,4,'N',NULL),
	(86,26,0,27,1,0,'0','3','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','Add sagepay to animal dna','wating for sage details',NULL,1,NULL,NULL,6,'N',NULL),
	(87,20,0,25,9,0,'0','1','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','adding another task here','these are the notes',NULL,1,NULL,NULL,1,'N',NULL),
	...
	(94,21,87,24,0,0,'0','0','2012-11-15 00:00:00','2012-11-15 00:00:00','2012-11-15 00:00:00','hello','',NULL,1,NULL,NULL,NULL,'N',NULL),
	(95,22,94,23,0,0,'0','0','2012-11-15 00:00:00','2012-11-15 00:00:00','2012-11-15 00:00:00','hi there ','',NULL,1,NULL,NULL,NULL,'Y','2012-11-15 00:00:00');

/*!40000 ALTER TABLE `tasks` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tasks_to_customers
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tasks_to_customers`;

CREATE TABLE `tasks_to_customers` (
...
LOCK TABLES `tasks_to_users` WRITE;
/*!40000 ALTER TABLE `tasks_to_users` DISABLE KEYS */;

INSERT INTO `tasks_to_users` (`task_to_user_id`, `task_id`, `user_id`, `sort`)
VALUES
	(10,12,1,8),
	(11,12,1,8),
	(12,13,0,NULL),
...
INSERT INTO `users` (`user_id`, `name`, `email`, `display_name`, `password`, `phone`, `bio`, `twitter`, `is_logged_in`, `privilage`)
VALUES
...
INSERT INTO `users_to_group` (`user_to_group_id`, `user_id`, `group_id`)
VALUES
	(1,1,4),
	(2,2,4),
	(3,3,2),
