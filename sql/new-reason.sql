...
-- Dumping data for table my.company.tasks: ~29 rows (approximately)
DELETE FROM `tasks`;
...
-- Dumping data for table my.company.tasks_to_users: ~42 rows (approximately)
...
-- Dumping data for table my.company.task_comments: ~8 rows (approximately)
