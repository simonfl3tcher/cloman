<form action="" method="post" id="addContactForm" data-ajaxurl='<?php echo base_url("businesses/add"); ?>' data-useAjax='true' class="form-horizontal">	
	<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade" id="myModal" style="display: none;">
	            <div class="modal-header">
	              ...
	              <span class="icon businessIcon"></span>
	            </div>
	            <div class="modal-body">		
	            	<div class="addWrapper">		
						<table class="std ">
								...
								<tr>
									<td>
										...
										<span><input type="text" value="" id="address_Region" name="address[Region]"></span>
									</td>
									<td>
						...
						<table class="std">
							<tr>
								<td><input id="my-text-input" type="text" name="contact[Current]" class="selectContacts" /></td>
								<td>
						...
						<div class="businessForm">
							<div class="paddingTop-20 paddingBottom">
								<span class="icon personIcon"></span>
							</div>
							<table class="std">
							<tbody>
								<tr class="largeField">
		    ...
		    <div class="modal-footer">
		      ...
		      <button data-dismiss="modal" type="submit" class="btn btn-primary add">Save Business</button>
		    </div>
  		</div>
</form>
<div class="clear"></div>