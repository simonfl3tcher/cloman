...
<div id="footer">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="span6">
				© 2012 <a href="http://logicdesign.co.uk">Logic Design</a>, all rights reserved.
			</div> <!-- /span6 -->
			
			<div id="builtby" class="span6">
				<a href="http://logicdesign.co.uk">Maintained by Logic Design.</a>				
			</div> <!-- /.span6 -->
...
<script src="<?php echo base_url(); ?>client_assets/js/plugins/msgGrowl/js/msgGrowl.js"></script>
<script src="<?php echo base_url(); ?>client_assets/js/plugins/lightbox/jquery.lightbox.js"></script>
<script src="<?php echo base_url(); ?>client_assets/js/plugins/msgbox/jquery.msgbox.min.js"></script>
<script src="<?php echo base_url(); ?>client_assets/js/plugins/hoverIntent/jquery.hoverIntent.minified.js"></script>
